...
class NewSlotFormFallback extends Component {

    componentDidMount() {
        if (!this.props.item.img) {
            this.props.validate('fallbackImageUrl', {
                isValid: false,
        ...
        if (!this.props.item.img) {
            this.props.validate('fallbackAdUrl', {
                isValid: false,
                err: { msg: 'ERR_REQUIRED_FIELD' },
                dirty: false
            })
...
const NewSlotFormFallbackForm = NewItemHoc(NewSlotFormFallback)
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(Translate(NewSlotFormFallbackForm))
