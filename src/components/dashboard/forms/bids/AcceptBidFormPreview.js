...
class AcceptBidFormPreview extends Component {
  render() {
...
AcceptBidFormPreview.propTypes = {
...
let AcceptBidFormPreviewForm = NewBidHoc(AcceptBidFormPreview)
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(AcceptBidFormPreviewForm)
