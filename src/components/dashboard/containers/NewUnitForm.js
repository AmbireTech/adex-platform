...
class NewUnitForm extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Button icon='add' label='Add new Unit' onClick={this.handleToggle} primary raised />
                <Dialog
                ...
                >
                    <section>
                        ...
                        <Input type='text' label='Inage url' name='img' value={unit._meta.img} onChange={this.handleChange.bind(this, 'img')} maxLength={1024} />
